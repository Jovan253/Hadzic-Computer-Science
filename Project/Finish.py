...
class Level(pygame.sprite.Sprite):
    def __init__(self, player, hades):
        ...
        self.player = player
        self.hades = hades
        self.block1 = Block("platform.png", 120, 30, 0, 360, 0, False)
        self.block_list.add(self.block1)
        self.start = 0
        self.end = 0
        self.leaderboard = []
        ...
        for i in range(10):
            ...
            self.leaderboard.append(score_f.read())
        score_f.close()
    ...
    def finish(self):
        ...
        for i in range(10):
            score_f = open("Leaderboard.txt", "wt")
            if time_taken > self.leaderboard(i):
                score_f.write(str(time_taken))
        score_f.close()
...
lava = Block("lava.png", 3000, 60, 0, size[1] - 30, 0, False)
