...
Blinky_x_blocked = True
Blinky_y_blocked = False
...
while not done:
    ...
    if Blinky_pos in Node_List:
        ...
        print("blinky in node = ", Blinky.rect.x, Blinky.rect.y)
            ...
            if pacman.rect.x == Blinky.rect.x:
                ...
                for tile in wall_list:
                    if Blinky.rect.y == tile.rect.y and Blinky.rect.x + 30 == tile.rect.x:
                        print("l/r right blocking tile at x = ", tile.rect.x)
                        Blinky.horizontal(-1)
                        Blinky_x_blocked = True
                        Blinky_y_blocked = False
                        break
                if not Blinky_x_blocked:
                    for tile in wall_list:
                        if Blinky.rect.y == tile.rect.y and Blinky.rect.x - 30 == tile.rect.x:
                            print("l/r left blocking tile at x = ", tile.rect.x)
                            Blinky.horizontal(1)
                            Blinky_x_blocked = True
                            Blinky_y_blocked = False
                            break
                ...
                for tile in wall_list:
                    if Blinky.rect.y == tile.rect.y and Blinky.rect.x + 30 == tile.rect.x:
                        print("right blocking tile at x = ", tile.rect.x)
                        Blinky_x_blocked = True
                        Blinky_y_blocked = False
                        break
                Blinky.horizontal(1)
                ...
                for tile in wall_list:
                    if Blinky.rect.y == tile.rect.y and Blinky.rect.x - 30 == tile.rect.x:
                        print("left blocking tile at x = ", tile.rect.x)
                        Blinky_x_blocked = True
                        Blinky_y_blocked = False
                        break
                Blinky.horizontal(-1)
            ...
            if pacman.rect.y == Blinky.rect.y:
                ...
                for tile in wall_list:
                    if Blinky.rect.x == tile.rect.x and Blinky.rect.y - 30 == tile.rect.y:
                        print("u/d top blocking tile at y = ", tile.rect.y)
                        Blinky.vertical(1)
                        Blinky_y_blocked = True
                        Blinky_x_blocked = False
                        break
                if not Blinky_y_blocked:
                    for tile in wall_list:
                        if Blinky.rect.x == tile.rect.x and Blinky.rect.y + 30 == tile.rect.y:
                            print("u/d bottom blocking tile at y = ", tile.rect.y)
                            Blinky.vertical(-1)
                            Blinky_y_blocked = True
                            Blinky_x_blocked = False
                            break
                ...
                for tile in wall_list:
                    if Blinky.rect.x == tile.rect.x and Blinky.rect.y - 30 == tile.rect.y:
                        print("top blocking tile at y = ", tile.rect.y)
                        Blinky_y_blocked = True
                        Blinky_x_blocked = False
                        break
                Blinky.vertical(-1)
                ...
                for tile in wall_list:
                    if Blinky.rect.x == tile.rect.x and Blinky.rect.y + 30 == tile.rect.y:
                        print("bottom blocking tile at y = ", tile.rect.y)
                        Blinky_y_blocked = True
                        Blinky_x_blocked = False
                        break
                Blinky.vertical(1)
