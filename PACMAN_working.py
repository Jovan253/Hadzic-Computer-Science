...
while not done:
    ...
    for junction in junction_list:
        ...
        if BlinkyAtJunction:
            ...
            if pacman.rect.x == Blinky.rect.x and pacman.rect.y == Blinky.rect.y:
                break

            if pacman.rect.x <= Blinky.rect.x and pacman.rect.y <= Blinky.rect.y:
                # packman in top left quadrant
                if junction.canGoUp and not Blinky.moving == "DOWN":
                    Blinky.moveUp()
                elif junction.canGoLeft and not Blinky.moving == "RIGHT":
                    Blinky.moveLeft()
                elif junction.canGoRight and not Blinky.moving == "LEFT":
                    Blinky.moveRight()
                elif junction.canGoDown and not Blinky.moving == "UP":
                    Blinky.moveDown()
                else:
                ...
                if junction.canGoLeft and not Blinky.moving == "RIGHT":
                    Blinky.moveLeft()
                elif junction.canGoDown and not Blinky.moving == "UP":
                    Blinky.moveDown()
                elif junction.canGoRight and not Blinky.moving == "LEFT":
                    Blinky.moveRight()
                elif junction.canGoUp  and not Blinky.moving == "DOWN":
                    Blinky.moveUp()
                else:
                    print("stuck at junction ", junction.x, junction.y)
                ...
                if junction.canGoRight and not Blinky.moving == "LEFT":
                    Blinky.moveRight()
                elif junction.canGoUp and not Blinky.moving == "DOWN":
                    Blinky.moveUp()
                elif junction.canGoLeft and not Blinky.moving == "RIGHT":
            ...
            print(Blinky.moving, Blinky.rect.x, Blinky.rect.y)
